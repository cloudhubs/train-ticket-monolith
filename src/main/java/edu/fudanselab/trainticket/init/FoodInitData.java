...
@Component
public class FoodInitData implements CommandLineRunner{

    @Autowired
    StationFoodService service;

    private static final Logger LOGGER = LoggerFactory.getLogger(FoodInitData.class);
    ...
    public void run(String... args) throws Exception {
        ...
        try{
            ...
            FoodInitData.LOGGER.info("the foodstores.txt has format error!");
            FoodInitData.LOGGER.error(e.getMessage());
            System.exit(1);
        }
