 ...
 */
@Service
public class TravelService2Impl implements TravelService2 {
    ...
    public Response getRouteByTripId(String tripId, HttpHeaders headers) {
        ...
        if (trip == null) {
            TravelService2Impl.LOGGER.error("[getRouteByTripId][Get Route By Trip ID Fail][Trip Not Found][TripId: {}]", tripId);
            ...
            if (route == null) {
                TravelService2Impl.LOGGER.error("[getRouteByTripId][Get route by Trip id error][Route not found][RouteId: {}]",trip.getRouteId());
                return new Response<>(0, "\"[Get Route By Trip ID] Route Not Found:\" + trip.getRouteId()", null);
            } else {
                TravelService2Impl.LOGGER.info("[getRouteByTripId][Get Route By Trip ID Success]");
    ...
    public Response getTrainTypeByTripId(String tripId, HttpHeaders headers) {
        ...
        if (trip != null) {
            ...
            TravelService2Impl.LOGGER.error("[getTrainTypeByTripId[]Get Train Type by Trip id error][Trip not found][TripId: {}]",tripId);
        }
        if (trainType != null) {
            return new Response<>(1, "Success query Train by trip id", trainType);
        } else {
            TravelService2Impl.LOGGER.error("[getTrainTypeByTripId][Get Train Type by Trip id error][Train Type not found][TripId: {}]",tripId);
    ...
    public Response getTripByRoute(ArrayList<String> routeIds, HttpHeaders headers) {
        ...
        if (!tripList.isEmpty()) {
            ...
            TravelService2Impl.LOGGER.warn("[getTripByRoute][Get Trips by Route ids warn][Trips not found][RouteIdNumber: {}]",routeIds.size());
            return new Response<>(0, noCnontent, null);
        }
    }
    ...
    public Response create(edu.fudanselab.trainticket.entity.TravelInfo info, HttpHeaders headers) {
        ...
        if (repository.findByTripId(ti) == null) {
            ...
            TravelService2Impl.LOGGER.error("[getTripByRoute][Create trip error][Trip already exists][TripId: {}]",info.getTripId());
    ...
    public Response retrieve(String tripId, HttpHeaders headers) {
        ...
        if (trip != null) {
            ...
            TravelService2Impl.LOGGER.error("[retrieve][Retrieve trip error][Trip not found][TripId: {}]",tripId);
    ...
    public Response update(edu.fudanselab.trainticket.entity.TravelInfo info, HttpHeaders headers) {
        ...
        if (t != null) {
            ...
            TravelService2Impl.LOGGER.error("[update][Update trip error][Trip not found][TripId: {}]",info.getTripId());
    ...
    public Response delete(String tripId, HttpHeaders headers) {
        ...
        if (repository.findByTripId(ti) != null) {
            ...
            TravelService2Impl.LOGGER.error("[delete][Delete trip error][Trip not found][TripId: {}]",tripId);
    ...
    public Response query(TripInfo info, HttpHeaders headers) {
        ...
        if(allTripList != null){
            for (Trip tempTrip : allTripList) {
                ...
                if (response == null) {
                    TravelService2Impl.LOGGER.warn("[query][Query trip error][Tickets not found][start: {},end: {},time: {}]", StartPlaceName, endPlaceName, info.getDepartureTime());
                }else{
                    list.add(response);
                }
            }
    ...
    public Response getTripAllDetailInfo(TripAllDetailInfo gtdi, HttpHeaders headers) {
        ...
        TravelService2Impl.LOGGER.debug("[getTripAllDetailInfo][gtdi info: {}]", gtdi.toString());
        Trip trip = repository.findByTripId(new TripId(gtdi.getTripId()));
        if (trip == null) {
            gtdr.setTripResponse(null);
            gtdr.setTrip(null);
            TravelService2Impl.LOGGER.error("[getTripAllDetailInfo][Get trip detail error][Trip not found][TripId: {}]",gtdi.getTripId());
            ...
            if (tripResponse == null) {
                gtdr.setTrip(null);
                gtdr.setTripResponse(null);
                TravelService2Impl.LOGGER.warn("[getTripAllDetailInfo][Query trip error][Tickets not found][start: {},end: {}]", gtdi.getTo(), gtdi.getFrom());
    ...
    private List<TripResponse> getTicketsByBatch(List<Trip> trips, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers) {
        ...
        if (!afterToday(departureTime)) {
            TravelService2Impl.LOGGER.info("[getTickets][depaturetime not vailid][departuretime: {}]", departureTime);
            return responses;
        }
        ...
        TravelService2Impl.LOGGER.info("[getTicketsByBatch][before get basic][trips: {}]", trips);
        ...
        if(r.getStatus() == 0){
            TravelService2Impl.LOGGER.info("[getTicketsByBatch][Ts-basic-service response status is 0][response is: {}]", r);
            return responses;
        }
        ...
        try{
            ...
            TravelService2Impl.LOGGER.warn("[getTicketsByBatch][Ts-basic-service convert data failed][Fail msg: {}]", e.getMessage());
            return responses;
        }
    ...
    private TripResponse getTickets(Trip trip, Route route1, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers) {
        ...
        Response r = re.getBody();
        if(r.getStatus() == 0){
            TravelService2Impl.LOGGER.info("[getTickets][Ts-basic-service response status is 0][response is: {}]", r);
            return null;
        }
    ...
    private TripResponse setResponse(Trip trip, TravelResult tr, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers){
        ...
        TravelService2Impl.LOGGER.info("[getTickets][Calculate distance][calculate time：{}  time: {}]", minutesStart, calendarStart.getTime());
        ...
        TravelService2Impl.LOGGER.info("[getTickets][Calculate distance][calculate time：{}  time: {}]", minutesEnd, calendarEnd.getTime());
    ...
    public Response queryAll(HttpHeaders headers) {
        ...
        TravelService2Impl.LOGGER.warn("[queryAll][Query all trips warn][{}]","No Content");
        return new Response<>(0, noCnontent, null);
    }
    ...
    private Route getRouteByRouteId(String routeId, HttpHeaders headers) {
        TravelService2Impl.LOGGER.debug("[getRouteByRouteId][Get Route By Id][Route ID：{}]", routeId);
        HttpEntity requestEntity = new HttpEntity(null);
        ...
        if (result.getStatus() == 0 ) {
            TravelService2Impl.LOGGER.error("[getRouteByRouteId][Get Route By Id Fail][Route not found][RouteId: {}]", routeId);
            return null;
        } else {
            TravelService2Impl.LOGGER.info("[getRouteByRouteId][Get Route By Id Success]");
    ...
    private int getRestTicketNumber(String travelDate, String trainNumber, String startStationName, String endStationName, int seatType, int totalNum, List<String> stationList, HttpHeaders headers) {
        ...
        TravelService2Impl.LOGGER.info("[getRestTicketNumber][Seat request][request: {}]", seatRequest.toString());
        ...
        TravelService2Impl.LOGGER.info("[getRestTicketNumber][Get Rest tickets num][num is: {}]", re.getBody().toString());
    ...
    public Response adminQueryAll(HttpHeaders headers) {
        ...
        if (!adminTrips.isEmpty()) {
            ...
            TravelService2Impl.LOGGER.warn("[adminQueryAll][Admin query all trips warn][{}]","No Content");
            return new Response<>(0, noCnontent, null);
        }
    }
